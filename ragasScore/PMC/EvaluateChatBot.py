...
def EvalChatBot(pathToPDF: str, query: str):
...
# dict = ChatBot("../../pdfData/Cells and Chemistry of Life.pdf", "What is cell?")
# print(dict['contexts'])
# print(dict['answer'])
# print("This is len of contexts: " + str(len(dict['contexts'])))
